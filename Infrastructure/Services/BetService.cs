...
namespace SportsBetting.Api.Infrastructure.Services
{
    ...
    public class BetService(
        ...
        IConfiguration configuration) : IBetService
    {
        private readonly ApplicationDbContext _context = context ?? throw new ArgumentNullException(nameof(context));
        private readonly ILogger<BetService> _logger = logger ?? throw new ArgumentNullException(nameof(logger));
        ...
        public async Task<BetResponseDto?> CreateBetAsync(int userId, CreateBetDto betDto)
        {
            ...
            return await executionStrategy.ExecuteAsync(async () =>
            {
                ...
                try
                {
                    ...
                    if (user is null || eventEntity is null)
                    {
